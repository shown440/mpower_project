...
excel_raw_df = pd.read_excel('E:\Office-Works\mPower\git-repository\col_map_py\dataupload.xlsx','Sheet1')
...
with open('E:\Office-Works\mPower\git-repository\col_map_py\myjson.json') as jf:
    selected_table = json.load(jf)
        ...
        for key in range(0, len(keys)):
            ...
            if col_data_type == "boolean":
                try:
                    ...
                    print("^^^Exception occur: ", json_list[dictionary][keys[key]]+" is not boolean value.")
                ...
                try:
                    ...
                    print("^^^Exception occur: ", json_list[dictionary][keys[key]]+" is not integer value.") 
                ...
                try:
                    ...
                    print("^^^Exception occur: ", json_list[dictionary][keys[key]]+" is not date time value.") 
                ...
                try:
                    ...
                    print("^^^Exception occur: ", json_list[dictionary][keys[key]]+" is not string value.") 
